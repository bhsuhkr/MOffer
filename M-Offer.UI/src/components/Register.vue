  ...
  <div class="register-container">
    ...
    <form @submit.prevent="submitForm" class="register-form">
      ...
      <div>
        ...
        <input type="text" id="korName" ref="korNameField" autocomplete="off" v-model="korName" required />
      </div>
      <div>
        <label for="engName">영문 이름:</label>
        <input type="text" id="engName" ref="engNameField" autocomplete="off" v-model="engName" required />
      </div>
      <div>
